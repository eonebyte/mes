...
const ConfirmStartMultiPlan = ({ data, navidate, resourceId }) => {
    Modal.confirm({
        title: 'Confirm Start',
        content: (
            <>
                ...
                <Space>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            fetch(`${backendUrl}${prefix}/plan/resource/start/multiplan`, {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
                                body: JSON.stringify({ planIdArray, resourceId }),
                                credentials: 'include',
                            })
                                .then(async res => {
...
export default ConfirmStartMultiPlan;